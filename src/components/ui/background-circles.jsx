...
export function BackgroundCircles({
    ...
    return (
        ...
        >
            <AnimatedGrid />
            <motion.div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] opacity-30">
                {[0, 1, 2].map((i) => (
                    <motion.div
                        key={i}
                        className={clsx(
            ...
            <div className="absolute inset-0 [mask-image:radial-gradient(90%_60%_at_50%_50%,#000_40%,transparent)]">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#0F766E/20%,transparent_70%)] blur-[120px]" />
...
export function DemoCircles() {
    const [currentVariant, setCurrentVariant] = useState("tertiary");
    ...
    return (
        <>
            <BackgroundCircles variant={currentVariant} showContent={true} />
